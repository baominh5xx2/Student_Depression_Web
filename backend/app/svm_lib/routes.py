...
# Check if model and feature file exist
if not os.path.exists(MODEL_PATH) or not os.path.exists(FEATURE_PATH):
    raise RuntimeError(f"Model or feature file not found at {MODEL_PATH} or {FEATURE_PATH}. Please train the model first.")
...
@router.post("/predict/svm_lib")
def predict(features: Dict[str, Any]):
    """
    API endpoint for depression prediction using SVM.
